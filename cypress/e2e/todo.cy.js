describe("functionality of todo list",()=>{
    ...
    it("should return back to the viewing template without changes when cancel button is clicked",()=>{
        cy.visit('http://localhost:3000');
        cy.get('[data-testid="edit-button"]').click({'multiple':'true'});
    ...
    it("should delete task when clicked on delete button",()=>{
        cy.visit('http://localhost:3000');
